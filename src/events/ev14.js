...
import im1 from "../assets/images/event-assets/14_Week of Welcome/Poster.jpg";
          ...
          <div className="row justify-content-center">
            <div className="col-lg-12">
              <div className="bannerInnerDetais">
                <p>
                The Habib University Orchestra and the Ustads from the Khawaja Mashooqullah Music Room marked the Week of Welcome for the incoming class of 2026 with a captivating performance.
                </p>
              </div>
              <Fancybox
                options={{
